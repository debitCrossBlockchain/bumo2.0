...
namespace bumo{
	...
	bool V8Contract::Initialize(int argc, char** argv) {
		...
		js_func_read_["getValidateCandidate"] = V8Contract::CallBackGetValidatorCadidate;
		...
		js_func_write_["setValidateCandidate"] = V8Contract::CallBackSetValidatorCadidate;
...
//			args.GetReturnValue().Set(ret);
	...
	void V8Contract::CallBackGetValidatorCadidate(const v8::FunctionCallbackInfo<v8::Value>& args){
		do {
			if (args.Length() != 1) {
				LOG_TRACE("parameter error");
				break;
