...
const (
	...
	MONITOR_MESSAGE_TYPE_MONITOR_MSGTYPE_BUMO              MONITOR_MESSAGE_TYPE = 32
...
func (m *BumoStatus) Reset()         { *m = BumoStatus{} }
func (m *BumoStatus) String() string { return proto.CompactTextString(m) }
func (*BumoStatus) ProtoMessage()    {}
func (*BumoStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_monitor_2647886f338c3a47, []int{5}
}
func (m *BumoStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BumoStatus.Unmarshal(m, b)
}
func (m *BumoStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BumoStatus.Marshal(b, m, deterministic)
}
func (dst *BumoStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BumoStatus.Merge(dst, src)
}
func (m *BumoStatus) XXX_Size() int {
	return xxx_messageInfo_BumoStatus.Size(m)
}
func (m *BumoStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_BumoStatus.DiscardUnknown(m)
}

var xxx_messageInfo_BumoStatus proto.InternalMessageInfo

func (m *BumoStatus) GetGlueManager() *GlueManager {
	if m != nil {
...
func (m *BumoStatus) GetPeerManager() *PeerManager {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*BumoStatus)(nil), "monitor.BumoStatus")
