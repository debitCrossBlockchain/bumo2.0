...
const MESSAGE_CHANNEL_CHALLENGE_WITHDRAWAL_TYPE MESSAGE_CHANNEL_CHALLENGE_WITHDRAWAL_TYPE_MAX = MESSAGE_CHANNEL_CHALLENGE_WITHDRAWAL_TYPE_CONTRACT_CPC_QUERY;
