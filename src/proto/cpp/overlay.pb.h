...
enum MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE {
  MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE_NONE = 0,
...
const MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE_MIN = MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE_NONE;
const MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE_MAX = MESSAGE_CHANNEL_CHALLENGE_HEAD_TYPE_NONEXIST;
