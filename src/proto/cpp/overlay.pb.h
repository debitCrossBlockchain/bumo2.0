...
enum MESSAGE_CHANNEL_TYPE {
  ...
  MESSAGE_CHANNEL_QUWERY_SUBMIT_HEAD = 16,
  MESSAGE_CHANNEL_QUWERY_WITHDRAWAL = 17,
...
const MESSAGE_CHANNEL_TYPE MESSAGE_CHANNEL_TYPE_MAX = MESSAGE_CHANNEL_QUWERY_WITHDRAWAL;
