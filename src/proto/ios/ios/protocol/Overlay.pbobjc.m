  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "bumoVersion",
        .dataTypeSpecific.className = NULL,
        .number = Hello_FieldNumber_BumoVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Hello__storage_, bumoVersion),
        .flags = GPBFieldOptional,
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "bumoVersion",
        .dataTypeSpecific.className = NULL,
        .number = ChainStatus_FieldNumber_BumoVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(ChainStatus__storage_, bumoVersion),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
