...
.. tips:: |
| The bumo/ directory will be created automatically during the BUMO source
| code being downloaded, and the source code files will be stored in this directory.
...
.. tips:: |
|The executable files **bumo** and **bumod** generated after
