...
.. tips:: The bumo/ directory will be created automatically during the
...
.. tips:: The executable files **bumo** and **bumod** generated after
...
-  For the example of API guide for the exchange, visit the following
   link:
