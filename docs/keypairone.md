...
There are two methods of calling the interface to execute transactions: [Generating Transaction_blobs by Calling the Interface](#generating-transaction-blobs-by-calling-the-Interface) and [Generating Transaction_blobs by Yourself](#generating-transactionblobs-by-yourself).
